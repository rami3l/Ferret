...
class GeneConverterTest {
    ...
    void getLocusFromFile_ShouldReturnLocus() {
        ...
        var json = new JsonDocument(getContent("ncbi/gene-id-to-locus/1234.json"));
    ...
    void getLocusFromUnknownOrDiscontinuedId_ShouldReturnEmpty() {
        ...
        var json1 = new JsonDocument(getContent("ncbi/gene-id-to-locus/123456.json"));
        // https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esummary.fcgi?db=gene&id=0&format=json
        var json2 = new JsonDocument(getContent("ncbi/gene-id-to-locus/0.json"));
    ...
    void getIdFromFile_ShouldReturnGeneId() {
        ...
        var json = new JsonDocument(getContent("ncbi/gene-name-to-id/CR5.json"));
    ...
    void getIdFromUnknownName_ShouldReturnEmpty() {
        ...
        var json = new JsonDocument(getContent("ncbi/gene-name-to-id/unknown.json"));
